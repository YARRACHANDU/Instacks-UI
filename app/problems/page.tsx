...
export default function ProblemsPage() {
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-white text-black pt-24 pb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {currentQuestions.map((item: any) => (
              ...
              >
                ...
                <span
                  className={`inline-block mt-3 px-3 py-1 text-[10px] md:text-xs font-semibold rounded-full
                  ${
                    item.level === "basic"
        ...
        {selected && (
          <div className="fixed inset-0 bg-black/50 flex justify-center items-center px-4 z-50">
            <div className="bg-white rounded-2xl p-5 md:p-6 w-full max-w-md shadow-xl">
              ...
              <p className="text-gray-700 text-sm md:text-base my-3">
